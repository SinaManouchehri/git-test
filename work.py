...
print("The third one by sina-branch owner as well.")
print("Forth commit by sina-branch owner.")
print("This line is added by master and commited.")
print("The third one by sina-branch owner as well.")
print("The new commit 2 by master.")
